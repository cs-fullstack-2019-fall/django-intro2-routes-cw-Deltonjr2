...
#### you did not need to define the path inside your project as route66. You successfully added both endpoints and managed to link them to the right route. 4/5 Score: 3/3
